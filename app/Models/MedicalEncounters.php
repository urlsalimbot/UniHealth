...
class MedicalEncounters extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            if (empty($model->encounter_id)) {
                $model->encounter_id = (string) Str::uuid();
            }
        });
    }
    ...
    /** 
     * A medical encounter has many attachments.
     */
    public function attachments(): HasMany
    {
        return $this->hasMany(EncounterAttachments::class, 'encounter_id', 'encounter_id');
    }
