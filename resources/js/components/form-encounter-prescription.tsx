...
export default function PatientPrescriptionForm({ data = {}, ...Actions }: any) {
    return (
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) => Actions.setData('medication_id', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) => Actions.setData('dosage', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) => Actions.setData('frequency', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) => Actions.setData('route', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) => Actions.setData('duration', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                type="number"
                                defaultValue={data?.quantity_prescribed ?? ''}
                                onChange={(e) => Actions.setData('quantity_prescribed', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                type="number"
                                defaultValue={data?.refills_allowed ?? ''}
                                onChange={(e) => Actions.setData('refills_allowed', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                type="text"
                                defaultValue={data?.prescription_status ?? ''}
                                onChange={(e) => Actions.setData('prescription_status', e.target.value)}
                            />
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                type="date"
                                defaultValue={data?.prescription_date ?? ''}
                                onChange={(e) => Actions.setData('prescription_date', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) => Actions.setData('start_date', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Input
                                ...
                                onChange={(e) => Actions.setData('end_date', e.target.value)}
                            />
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div className="flex flex-col space-y-1">
                            ...
                            <Textarea
                                ...
                                onChange={(e) => Actions.setData('indication', e.target.value)}
                            />
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <Textarea
                                ...
                                defaultValue={data?.special_instructions ?? ''}
                                onChange={(e) => Actions.setData('special_instructions', e.target.value)}
                            />
